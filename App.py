...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='sumit3108',db='cv')
...
def run():
    ...
    img = Image.open('./Logo/resume-scanner-01.png')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://www.linkedin.com/in/krishna-sharma-b6015125b/" style="text-decoration: none; color: #021659;">Krishna sharma and Akshat khatri</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with by 
            <a href="/" style="text-decoration: none; color: grey;">Krishna sharma</a> through 
            <a href="https://www.linkedin.com/in/krishna-sharma-b6015125b/" style="text-decoration: none; color: grey;">(Data Scientist)</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Krishna and Akshat Khatri ! Total %d " % values + " User's Have Used Our Tool : )")                
